...
class EmployeeCreateForm(forms.ModelForm):
	employeeid = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'please enter 5 characters without slashes eg. A0025'}))
...
class FamilyCreateForm(forms.ModelForm):
	...
	class Meta:
		model = Relationship
		fields = ['employee','status','spouse','tel','children','nextofkin','contact','relationship','father','mother']
