...
class Emergency(models.Model):
    ...
    tel = PhoneNumberField(default='+2547000000', null = False, blank=False, verbose_name='Phone Number (Example +254700000)', help_text= 'Enter number with Country Code Eg. +233240000000')
...
class Relationship(models.Model):
    ...
    status = models.CharField(_('Marital Status'),max_length=10,default=SINGLE,choices=STATUS)
    spouse = models.CharField(_('Spouse (Fullname)'),max_length=255,blank=True,null=True)
    tel = PhoneNumberField(default=None, null = True, blank=True, verbose_name='Spouse Phone Number (Example +254000000)', help_text= 'Enter number with Country Code Eg. +2540000000')
    children = models.PositiveIntegerField(_('Number of Children'),null=True,blank=True,default=0)

    #recently added - 29/03/19
    nextofkin = models.CharField(_('Next of Kin'),max_length=255,help_text='fullname of next of kin')
    contact = PhoneNumberField(verbose_name='Next of Kin Phone Number (Example +254000000)',help_text='Phone Number of Next of Kin',null=True,blank=True)
    relationship = models.CharField(_('Relationship with Next of Person'),help_text='Who is this person to you ?',max_length=15,choices=NEXTOFKIN_RELATIONSHIP)
...
class Employee(models.Model):
    ...
    (TERTIARY,'Tertiary/University/Polytechnic/MA/PhD'),
    (OLEVEL,'OLevel'),
    (OTHER,'Other'),
    )
    ...
    image = models.FileField(_('Profile Image'),upload_to='media/profiles',default='default.png',blank=True,null=True,help_text='upload image size less than 2.0MB')#work on path username-date/image
    ...
    email = models.CharField(_('Email Address'),max_length=255, default='example@gmail.com')
    tel = PhoneNumberField(default='+2540000000', null = False, blank=False, verbose_name='Phone Number (Example +254000000)', help_text= 'Enter number with Country Code Eg. +2540000000')
    bio = models.CharField(_('Bio'),help_text='your biography,tell me something about yourself eg. inspirations ...',max_length=255,default='',null=True,blank=True)
    ...
    region = models.CharField(_('Region'),help_text='what region of the country(Kenya) are you from ?',max_length=20,default=NAIROBI,choices=KENYA_REGIONS,blank=False,null=True)
    ...
    education = models.CharField(_('Education'),help_text='highest educational standard ie. your highest level of schooling',max_length=20,default=TERTIARY,choices=EDUCATIONAL_LEVEL,blank=False,null=True)
    ...
    nhifnumber = models.CharField(_('NHIF Number'),max_length=30,null=True,blank=True)
    nssfnumber = models.CharField(_('NSSF Number'),max_length=15,null=True,blank=True)
